    ...
    return(
        <React.Fragment>
          ...
          <section>
                ...
                <div className="grid">
                    <div className="row">
                        <div className="col">
                            ...
                            <p className="fst-italic">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias aut, esse eveniet hic in ipsam iure laudantium necessitatibus quam quos repellat soluta veniam voluptate voluptates voluptatum? In itaque non quibusdam.</p>
                        </div>
                    </div>
                    <div className="row">
            ...
            {/*If loading happens then spinner, else data*/}
            {
